...
Date: 2024-12-04
Version: SilverKnight.cs
Summary: This program is the enemy logic for the SIlver Knight with the lowest speed of all the enemy knights.
...
public partial class SilverKnight : Node2D
{
	private const int SPEED = 100; // Speed constant
